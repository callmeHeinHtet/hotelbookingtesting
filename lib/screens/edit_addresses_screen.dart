...
class EditAddressesScreen extends StatefulWidget {
  const EditAddressesScreen({Key? key}) : super(key: key);
...
class _EditAddressesScreenState extends State<EditAddressesScreen>
          ...
          builder: (context, userProvider, child) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildAddressItem(addresses[index], userProvider);
              },
            );
          },
        ),
  ...
  Widget _buildAddressItem(SavedAddress address, UserProvider userProvider) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: address.isDefault ? _primaryGreen : _borderColor,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              if (!address.isDefault)
                TextButton(
                  onPressed: () => _setAsDefault(address, userProvider),
                  child: Text(
                    'Set as Default',
              ...
              TextButton.icon(
                onPressed: () => _showDeleteDialog(address, userProvider),
  ...
  void _setAsDefault(SavedAddress address, UserProvider userProvider) async {
  ...
  void _showDeleteDialog(SavedAddress address, UserProvider userProvider) {
    showDialog(
      context: context,
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                _buildDialogTextField(labelController, 'Label', 'e.g., Home, Office'),
                const SizedBox(height: 12),
                _buildDialogTextField(line1Controller, 'Address Line 1', 'Street address'),
                const SizedBox(height: 12),
                _buildDialogTextField(line2Controller, 'Address Line 2', 'Apt, suite (optional)'),
                const SizedBox(height: 12),
                _buildDialogTextField(cityController, 'City', 'City name'),
                const SizedBox(height: 12),
                _buildDialogTextField(stateController, 'State/Province', 'State or province'),
                const SizedBox(height: 12),
                _buildDialogTextField(postalController, 'Postal Code', 'Postal/ZIP code'),
                const SizedBox(height: 12),
                _buildDialogTextField(countryController, 'Country', 'Country'),
                const SizedBox(height: 12),
                Row(
                  children: [
                    Checkbox(
